...
INSERT INTO dbo.products (sku, name, slug, description, short_description, category_id, supplier_id, price, cost_price, compare_at_price, weight_kg, dimensions, is_active, is_featured, tax_rate, tags, attributes, images, geography_location) VALUES
(N'PHONE-001', N'ProMax Smartphone X', N'promax-smartphone-x', N'The latest flagship smartphone with advanced AI capabilities, 6.7" OLED display, and 5G connectivity.', N'Flagship 5G smartphone with AI features', 5, 0, 999.99, 650.00, 1199.99, 0.195, N'{"length": 16.5, "width": 7.8, "height": 0.8}', 1, 1, 8.25, N'["smartphone", "5G", "flagship"]', N'{"color": "Midnight Black", "storage": "256GB"}', N'[{"url": "https://cdn.example.com/phone-001-1.jpg"}]', geography::Point(37.7749, -122.4194, 4326)),
(N'PHONE-002', N'BudgetPhone SE', N'budgetphone-se', N'Affordable smartphone with essential features.', N'Affordable everyday smartphone', 5, 0, 299.99, 180.00, 349.99, 0.175, N'{"length": 15.0, "width": 7.2, "height": 0.9}', 1, 0, 8.25, N'["smartphone", "budget"]', N'{"color": "White", "storage": "64GB"}', N'[{"url": "https://cdn.example.com/phone-002-1.jpg"}]', NULL),
(N'LAPTOP-001', N'UltraBook Pro 15', N'ultrabook-pro-15', N'Premium ultrabook with Intel Core i9, 32GB RAM, 1TB SSD.', N'Premium 15" ultrabook for professionals', 6, 0, 1899.99, 1200.00, 2199.99, 1.85, N'{"length": 35.5, "width": 24.0, "height": 1.6}', 1, 1, 8.25, N'["laptop", "ultrabook", "professional"]', N'{"processor": "Intel Core i9", "ram": "32GB"}', N'[{"url": "https://cdn.example.com/laptop-001-1.jpg"}]', NULL),
(N'AUDIO-001', N'NoiseCancel Pro Headphones', N'noisecancel-pro-headphones', N'Premium wireless headphones with active noise cancellation.', N'Premium ANC wireless headphones', 7, 0, 349.99, 180.00, 399.99, 0.255, N'{"length": 18.0, "width": 16.0, "height": 8.0}', 1, 1, 8.25, N'["headphones", "wireless", "ANC"]', N'{"type": "Over-ear", "battery_life": "40 hours"}', N'[{"url": "https://cdn.example.com/audio-001-1.jpg"}]', NULL),
(N'GAME-001', N'GameStation 6', N'gamestation-6', N'Next-generation gaming console with 4K 120fps gaming.', N'Next-gen gaming console', 9, 0, 499.99, 380.00, 549.99, 4.5, N'{"length": 39.0, "width": 26.0, "height": 10.4}', 1, 1, 8.25, N'["gaming", "console", "4K"]', N'{"storage": "1TB SSD", "resolution": "4K 120fps"}', N'[{"url": "https://cdn.example.com/game-001-1.jpg"}]', NULL),
(N'SHIRT-001', N'Classic Oxford Shirt', N'classic-oxford-shirt', N'Timeless Oxford button-down shirt made from 100% premium cotton.', N'Premium cotton Oxford shirt', 10, 1, 59.99, 22.00, 79.99, 0.28, N'{"length": 76, "width": 58, "height": 2}', 1, 0, 0.00, N'["shirt", "oxford", "cotton"]', N'{"material": "100% Cotton", "fit": "Regular"}', N'[{"url": "https://cdn.example.com/shirt-001-1.jpg"}]', NULL),
(N'SHOE-001', N'RunMax Athletic Shoes', N'runmax-athletic-shoes', N'High-performance running shoes with responsive cushioning.', N'High-performance running shoes', 12, 1, 129.99, 55.00, 159.99, 0.62, N'{"length": 30, "width": 12, "height": 10}', 1, 1, 0.00, N'["shoes", "running", "athletic"]', N'{"material": "Mesh upper", "cushioning": "Responsive foam"}', N'[{"url": "https://cdn.example.com/shoe-001-1.jpg"}]', NULL),
(N'SOFA-001', N'ComfortPlus Sectional Sofa', N'comfortplus-sectional-sofa', N'Spacious L-shaped sectional sofa with memory foam cushions.', N'L-shaped sectional with memory foam', 13, 2, 1499.99, 750.00, 1899.99, 95.0, N'{"length": 290, "width": 180, "height": 85}', 1, 1, 8.25, N'["sofa", "sectional", "furniture"]', N'{"material": "Premium fabric", "frame": "Hardwood"}', N'[{"url": "https://cdn.example.com/sofa-001-1.jpg"}]', NULL),
(N'KNIFE-001', N'ChefMaster Knife Set', N'chefmaster-knife-set', N'Professional 15-piece knife set with high-carbon stainless steel blades.', N'Professional 15-piece knife set', 14, 2, 199.99, 85.00, 249.99, 3.2, N'{"length": 40, "width": 25, "height": 35}', 1, 0, 8.25, N'["kitchen", "knives", "chef"]', N'{"pieces": 15, "material": "Stainless steel"}', N'[{"url": "https://cdn.example.com/knife-001-1.jpg"}]', NULL),
(N'BOOK-001', N'The Art of Programming', N'the-art-of-programming', N'Comprehensive guide to software development best practices.', N'Programming best practices guide', 4, 4, 49.99, 15.00, 59.99, 0.95, N'{"length": 24, "width": 17, "height": 4}', 1, 0, 0.00, N'["book", "programming", "technology"]', N'{"author": "Dr. Jane Developer", "pages": 650}', N'[{"url": "https://cdn.example.com/book-001-1.jpg"}]', NULL);
GO
