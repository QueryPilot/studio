...
(N'PHONE-002', N'BudgetPhone SE', N'budgetphone-se', N'Affordable smartphone with essential features.', N'Affordable everyday smartphone', 6, 1, 299.99, 180.00, 349.99, 0.175, N'{"length": 15.0, "width": 7.2, "height": 0.9}', 1, 0, 8.25, N'["smartphone", "budget"]', N'{"color": "White", "storage": "64GB"}', N'[{"url": "https://cdn.example.com/phone-002-1.jpg"}]', NULL),
(N'LAPTOP-001', N'UltraBook Pro 15', N'ultrabook-pro-15', N'Premium ultrabook with Intel Core i9, 32GB RAM, 1TB SSD.', N'Premium 15" ultrabook for professionals', 7, 1, 1899.99, 1200.00, 2199.99, 1.85, N'{"length": 35.5, "width": 24.0, "height": 1.6}', 1, 1, 8.25, N'["laptop", "ultrabook", "professional"]', N'{"processor": "Intel Core i9", "ram": "32GB"}', N'[{"url": "https://cdn.example.com/laptop-001-1.jpg"}]', NULL),
...
(N'GAME-001', N'GameStation 6', N'gamestation-6', N'Next-generation gaming console with 4K 120fps gaming.', N'Next-gen gaming console', 10, 1, 499.99, 380.00, 549.99, 4.5, N'{"length": 39.0, "width": 26.0, "height": 10.4}', 1, 1, 8.25, N'["gaming", "console", "4K"]', N'{"storage": "1TB SSD", "resolution": "4K 120fps"}', N'[{"url": "https://cdn.example.com/game-001-1.jpg"}]', NULL),
(N'SHIRT-001', N'Classic Oxford Shirt', N'classic-oxford-shirt', N'Timeless Oxford button-down shirt made from 100% premium cotton.', N'Premium cotton Oxford shirt', 11, 2, 59.99, 22.00, 79.99, 0.28, N'{"length": 76, "width": 58, "height": 2}', 1, 0, 0.00, N'["shirt", "oxford", "cotton"]', N'{"material": "100% Cotton", "fit": "Regular"}', N'[{"url": "https://cdn.example.com/shirt-001-1.jpg"}]', NULL),
...
(N'BOOK-001', N'The Art of Programming', N'the-art-of-programming', N'Comprehensive guide to software development best practices.', N'Programming best practices guide', 5, 5, 49.99, 15.00, 59.99, 0.95, N'{"length": 24, "width": 17, "height": 4}', 1, 0, 0.00, N'["book", "programming", "technology"]', N'{"author": "Dr. Jane Developer", "pages": 650}', N'[{"url": "https://cdn.example.com/book-001-1.jpg"}]', NULL);
GO
