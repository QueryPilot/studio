# SSH Tunnels User Guide

This guide covers how to connect to databases through SSH tunnels in Query Pilot.
...
See [SSH Troubleshooting Guide](./ssh-and-ssm-troubleshooting.md) for common issues and solutions.
