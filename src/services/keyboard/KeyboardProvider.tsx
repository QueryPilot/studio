...
import type {
  KeyboardContext as KeyboardContextType,
  ViewContext,
} from "./types";
...
export function KeyboardProvider({
  ...
  const [context, setContext] = useState<KeyboardContextType>(() =>
    manager.getContext(),
  );
...
export function KeyboardScope({
  ...
  return (
    <div
      id={`keyboard-scope-${scopeContext}`}
      data-keyboard-context={scopeContext}
