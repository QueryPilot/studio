    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-[--cell-size] w-[--cell-size] select-none p-0 aria-disabled:opacity-50 !z-50",
        ...
        dropdown_root: cn(
          "has-focus:border-ring shadow-xs has-focus:ring-ring/50 has-focus:ring-[3px] relative",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-xs"
            : "[&>svg]:text-muted-foreground flex h-8 items-center gap-1 rounded-xl pl-2 pr-1 text-xs [&>svg]:size-3.5",
        ...
        day_button: cn("text-xs rounded-full", defaultClassNames.day_button),
        range_start: cn(
