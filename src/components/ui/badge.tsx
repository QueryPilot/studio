...
const badgeVariants = cva(
  "gap-1 rounded-full border border-transparent font-medium has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 inline-flex items-center justify-center w-fit whitespace-nowrap shrink-0 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive overflow-hidden group/badge",
  {
    variants: {
      ...
      size: {
        default: "h-5 px-2 py-0.5 text-[0.625rem] [&>svg]:size-2.5!",
        xs: "h-4 px-1 py-0 text-[0.625rem] [&>svg]:size-2!",
        sm: "h-6 px-2 py-0.5 text-xs [&>svg]:size-3!",
        lg: "h-7 px-2.5 py-1 text-xs [&>svg]:size-3.5!",
        xl: "h-8 px-3 py-1 text-xs [&>svg]:size-3.5!",
      },
    },
    defaultVariants: {
      variant: "default",
