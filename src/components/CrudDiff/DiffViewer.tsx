...
export function DiffViewer({
  ...
  return (
    <div className={cn("flex h-full flex-col gap-4", className)}>
      <header className="flex flex-wrap items-center justify-between gap-3 rounded-xl border bg-card/60 px-4 py-3">
        <div>
        ...
        <ul className="flex items-center gap-2 text-xs text-muted-foreground">
          <li>
            <strong className="text-foreground">{summary.dataCount}</strong>{" "}
            data changes
          </li>
          <li>
