    ...
    <div className="p-8 space-y-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Click a tab group to focus it, then hold Cmd/Ctrl and press 1-9 to
            switch tabs. Only the focused group will respond to shortcuts.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          {/* First Tab Group */}
          <div className="space-y-2">
            <h3 className="text-xs font-medium">Tab Group 1 (Top)</h3>
            <Tabs
              value={topTabValue}
            ...
            >
              ...
              <TabsContent value="tab1" className="p-4 border rounded-md">
                ...
                <p className="text-xs text-muted-foreground">
                  This is the dashboard content. Press{" "}
              ...
              <TabsContent value="tab2" className="p-4 border rounded-md">
                ...
                <p className="text-xs text-muted-foreground">
                  This is the analytics content. Press{" "}
                  <kbd className="px-1.5 py-0.5 text-xs bg-muted border rounded">
                    Cmd+2
                  </kbd>{" "}
                  to switch here.
              ...
              <TabsContent value="tab3" className="p-4 border rounded-md">
                ...
                <p className="text-xs text-muted-foreground">
                  This is the reports content. Press{" "}
                  <kbd className="px-1.5 py-0.5 text-xs bg-muted border rounded">
                    Cmd+3
                  </kbd>{" "}
                  to switch here.
              ...
              <TabsContent value="tab4" className="p-4 border rounded-md">
                ...
                <p className="text-xs text-muted-foreground">
                  This is the settings content. Press{" "}
                  <kbd className="px-1.5 py-0.5 text-xs bg-muted border rounded">
                    Cmd+4
                  </kbd>{" "}
                  to switch here.
              ...
              <TabsContent value="tab5" className="p-4 border rounded-md">
                ...
                <p className="text-xs text-muted-foreground">
                  This is the users content. Press{" "}
                  <kbd className="px-1.5 py-0.5 text-xs bg-muted border rounded">
                    Cmd+5
                  </kbd>{" "}
                  to switch here.
          ...
          {/* Second Tab Group */}
          <div className="space-y-2">
            <h3 className="text-xs font-medium">Tab Group 2 (Bottom)</h3>
            <Tabs
            ...
            >
              ...
              <TabsContent value="tab1" className="p-4 border rounded-md">
                ...
                <p className="text-xs text-muted-foreground">
                  This is a different tab group. When focused,{" "}
                  <kbd className="px-1.5 py-0.5 text-xs bg-muted border rounded">
                    Cmd+1
                  </kbd>{" "}
          ...
          <div className="p-4 bg-muted rounded-md space-y-2">
            <h4 className="font-semibold text-xs">How to Test:</h4>
            <ol className="text-xs space-y-1 list-decimal list-inside text-muted-foreground">
              ...
              <li>
                You should see numbered shortcuts (①, ②, ③...) appear on the
                focused tab group only
              </li>
              <li>
                While holding the modifier key, press a number (1-9) to switch
                tabs
              </li>
              <li>
                Try focusing different tab groups to verify context-aware
                behavior
              </li>
            </ol>
          </div>
