            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-2">
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => handleCopy(formattedValue, "JSON")}
                >
          ...
          <>
            ...
            <div className="flex justify-end gap-2">
              <Button
                size="sm"
                variant="outline"
                onClick={() => handleCopy(formattedValue, "text")}
              >
                <Copy className="h-4 w-4 mr-1" />
                Copy
              </Button>
              ...
              {typeof value === 'string' && value.includes('\n') && (
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => handleCopy(value.replace(/\n/g, '\\n'), "escaped")}
                >
              ...
              {typeof value === 'string' && value.includes(',') && (
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => handleCopy(`"${value.replace(/"/g, '""')}"`, "CSV")}
                >
              ...
              <Button
                size="sm"
                variant="outline"
                onClick={() => handleCopy(JSON.stringify(value), "JSON")}
              >
