          ...
          render={
            ...
            >
              <div className="flex items-center gap-2 mb-1.5">
                <img src={getDatabaseLogo(profile.db_type)} alt="" className="h-4 w-4" />
                ...
                {envTag && envColor && (
                  <span className={cn("text-[10px] px-1.5 py-0.5 rounded flex-shrink-0", envColor.bg, envColor.text)}>
                    {envTag}
                  </span>
                )}
              </div>
      ...
      <ContextMenuTrigger
        render={
          <div
            ...
            onDoubleClick={handleConnect}
          >
            <img src={getDatabaseLogo(profile.db_type)} alt="" className="h-5 w-5 flex-shrink-0" />
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-0.5">
                <span className="text-[10px] text-muted-foreground truncate">{profile.host}:{profile.port}</span>
                {profile.database && (
                  <>
                    <span className="text-[10px] text-muted-foreground">/</span>
                    <span className="text-[10px] text-muted-foreground truncate">{profile.database}</span>
                  </>
                )}
              </div>
            </div>
            ...
            <span className="text-[10px] text-muted-foreground flex-shrink-0">{lastUsedText}</span>
